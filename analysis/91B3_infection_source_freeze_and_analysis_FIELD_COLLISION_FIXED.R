...
OUT <- file.path(
  ROOT,
  "results",
  "V2_31B3_STEP91B_INFECTION_SOURCE_FREEZE_AND_ANALYSIS_FIELD_COLLISION_FIXED"
)
...
LOG <- file.path(
  OUT,
  "_STEP91B3_runtime_checkpoints.txt"
)

ERR <- file.path(
  OUT,
  "_STEP91B3_FATAL_ERROR.txt"
)
...
main <- function() {
  ...
  write_csv_safe(
    ...
    file.path(
      DIR_FREEZE,
      "V2_STEP91B3_PRJNA691455_literature_validated_source_mapping.csv"
    )
  )
  ...
  write_csv_safe(
    ...
    file.path(
      DIR_FREEZE,
      "V2_STEP91B3_source_analysis_eligibility_registry.csv"
    )
  )
  ...
  write_csv_safe(
    ...
    file.path(
      DIR_FREEZE,
      "V2_STEP91B3_PRJNA691455_preexisting_vs_literature_source_audit.csv"
    )
  )
  ...
  write_csv_safe(
    ...
    file.path(
      DIR_CORE,
      "V2_STEP91B3_PRJNA691455_patient_level_source_trajectory_metrics.csv"
    )
  )
  ...
  write_csv_safe(
    ...
    file.path(
      DIR_CORE,
      "V2_STEP91B3_PRJNA691455_source_stratified_exact_tests.csv"
    )
  )
  ...
  write_csv_safe(
    ...
    file.path(
      DIR_CORE,
      "V2_STEP91B3_PRJNA691455_source_group_descriptive_summary.csv"
    )
  )
  ...
  if (
    any(
      ext_guard$n_expected !=
        ext_guard$n_patients
    )
  ) {
    write_csv_safe(
      ext_guard,
      file.path(
        DIR_EXT,
        "V2_STEP91B3_PRJEB82425_FAILED_group_count_guard.csv"
      )
    )

    stop(
      "PRJEB82425 phenotype counts differ from published 17/12/9 grouping."
    )
  }
  ...
  write_csv_safe(
    ...
    file.path(
      DIR_EXT,
      "V2_STEP91B3_PRJEB82425_patient_level_coarse_infection_group.csv"
    )
  )
  ...
  write_csv_safe(
    ...
    file.path(
      DIR_EXT,
      "V2_STEP91B3_PRJEB82425_other_infection_subtypes_AGGREGATE_ONLY.csv"
    )
  )
  ...
  write_csv_safe(
    ...
    file.path(
      DIR_EXT,
      "V2_STEP91B3_PRJEB82425_Inclusion_anchor_D1_D5_DESCRIPTIVE_ONLY.csv"
    )
  )
  ...
  write_csv_safe(
    ...
    file.path(
      DIR_EXT,
      "V2_STEP91B3_PRJEB82425_Inclusion_anchor_D1_D5_DESCRIPTIVE_summary.csv"
    )
  )
  ...
  write_csv_safe(
    ...
    file.path(
      DIR_SYN,
      "V2_STEP91B3_integrated_source_interpretation.csv"
    )
  )

  readme <- c(
    "SEPSIS V2 - STEP91B3 INFECTION SOURCE FREEZE AND ANALYSIS",
    paste0(
      "Created: ",
      Sys.time()
    ),
    ...
    "",
    "PRJEB82425",
    "Published patient grouping is validated: VAP n=17, Other infection n=12, Control n=9.",
  ...
  writeLines(
    c(
      ...
      "PRJEB82425 coarse grouping validated; detailed Other-infection subtypes remain aggregate-only.",
      paste0(
