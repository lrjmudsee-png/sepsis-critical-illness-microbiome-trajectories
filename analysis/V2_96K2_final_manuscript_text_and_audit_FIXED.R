...
OUT <- file.path(
  RESULTS,
  "V2_96K2_FINAL_MANUSCRIPT_TEXT_AND_AUDIT_FIXED"
)
...
MANUSCRIPT_OUT <- file.path(
  OUT,
  "Manuscript_v5_1_SUBMISSION_DRAFT_FIXED.txt"
)
...
writeLines(
  c(
    "V2 STEP96K2 FINAL MANUSCRIPT TEXT AND AUDIT — FIXED",
    "",
    paste0("Title: ",TITLE),
    "",
    paste0(
