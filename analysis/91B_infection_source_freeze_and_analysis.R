...
OUT <- file.path(
  ROOT,
  "results",
  "V2_31B_STEP91B_INFECTION_SOURCE_FREEZE_AND_ANALYSIS"
)
...
LOG <- file.path(
  OUT,
  "_STEP91B_runtime_checkpoints.txt"
)

ERR <- file.path(
  OUT,
  "_STEP91B_FATAL_ERROR.txt"
)
...
main <- function() {
  ...
  write_csv_safe(
    ...
    file.path(
      DIR_FREEZE,
      "V2_STEP91B_PRJNA691455_literature_validated_source_mapping.csv"
    )
  )
  ...
  write_csv_safe(
    ...
    file.path(
      DIR_FREEZE,
      "V2_STEP91B_source_analysis_eligibility_registry.csv"
    )
  )
  ...
  write_csv_safe(
    ...
    file.path(
      DIR_CORE,
      "V2_STEP91B_PRJNA691455_patient_level_source_trajectory_metrics.csv"
    )
  )
  ...
  write_csv_safe(
    ...
    file.path(
      DIR_CORE,
      "V2_STEP91B_PRJNA691455_source_stratified_exact_tests.csv"
    )
  )
  ...
  write_csv_safe(
    ...
    file.path(
      DIR_CORE,
      "V2_STEP91B_PRJNA691455_source_group_descriptive_summary.csv"
    )
  )
  ...
  if (
    ...
    write_csv_safe(
      ...
      file.path(
        DIR_EXT,
        "V2_STEP91B_PRJEB82425_FAILED_group_count_guard.csv"
      )
    )
  ...
  write_csv_safe(
    ...
    file.path(
      DIR_EXT,
      "V2_STEP91B_PRJEB82425_patient_level_coarse_infection_group.csv"
    )
  )
  ...
  write_csv_safe(
    ...
    file.path(
      DIR_EXT,
      "V2_STEP91B_PRJEB82425_other_infection_subtypes_AGGREGATE_ONLY.csv"
    )
  )
  ...
  write_csv_safe(
    ...
    file.path(
      DIR_EXT,
      "V2_STEP91B_PRJEB82425_Inclusion_anchor_D1_D5_DESCRIPTIVE_ONLY.csv"
    )
  )
  ...
  write_csv_safe(
    ...
    file.path(
      DIR_EXT,
      "V2_STEP91B_PRJEB82425_Inclusion_anchor_D1_D5_DESCRIPTIVE_summary.csv"
    )
  )
  ...
  write_csv_safe(
    ...
    file.path(
      DIR_SYN,
      "V2_STEP91B_integrated_source_interpretation.csv"
    )
  )

  readme <- c(
    "SEPSIS V2 - STEP91B INFECTION SOURCE FREEZE AND ANALYSIS",
    paste0(
      "Created: ",
      Sys.time()
    ),
